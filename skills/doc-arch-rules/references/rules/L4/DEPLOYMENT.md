---
description: L4 交付层 文档 DEPLOYMENT 的更新规范——修改 docs/L4/DEPLOYMENT.md 时触发，按模板 frontmatter 的 generation 元数据（scan/ask_user/flow/checks/related）生成或更新该文档；模板全文（含 generation 元数据与 Markdown 正文）见本 rule 下方。
globs:
  - "docs/**/DEPLOYMENT.md"
---
