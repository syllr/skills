...
整体: {
  ...
  右侧贯穿竖条: {            # ← 贯穿栏：独立顶层容器，grid 列自动对齐高度
    width: 160
    grid-rows: 1; grid-columns: 1
    style.fill: "#f0fdf4"; style.stroke: "#22c55e"; style.border-radius: 12
    r1: { label: "日志记录"; height: 60; class: module }
    r2: { label: "消息系统"; height: 60; class: module }
    r3: { label: "权限控制"; height: 60; class: module }
  }
}
```
...
服务层: {
  ...
  通信组件: { grid-rows: 1; grid-columns: 1; grid-gap: 8   # 分区 1：内部嵌套
    c1: { width: 200; height: 50; class: module }
    c2: { width: 200; height: 50; class: module }
  }
  核心服务总线: { grid-rows: 1; grid-columns: 1; grid-gap: 8  # 分区 2
    s1: { width: 200; height: 50; class: module }
    s2: { width: 200; height: 50; class: module }
  }
  配置监控: { grid-rows: 1; grid-columns: 1; grid-gap: 8      # 分区 3
